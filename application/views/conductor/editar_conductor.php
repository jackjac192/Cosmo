<?php
	...
	<div class="row">
		...
		<?php 
					...
					echo form_open('conductor/editar/'.$conductor->cedula, $attributes);
		?>
		<header class="tituloReporte">
				<h1 data-target="edit_reportes"> <i class="fa fa-pencil-square" aria-hidden="true"></i>
 EDITAR CONDUCTOR</h1>
				<h3> 
					<?php
		...
		<section class="sectonwhite">
			<div class="col-lg-12">	
				...
				<br> <center>
					...
					<?= form_submit('mysubmit', 'Guardar!', '', 'class="btn btn-success btn-lg"'); ?>	
